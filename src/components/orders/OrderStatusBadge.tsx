...
const statusConfig: Record<string, { label: string; bgColor: string; textColor: string }> = {
  ...
  paid: { label: '待发货', bgColor: 'bg-blue-100', textColor: 'text-blue-800' },
  shipped: { label: '待收货', bgColor: 'bg-indigo-100', textColor: 'text-indigo-800' },
  delivered: { label: '待评价', bgColor: 'bg-amber-100', textColor: 'text-amber-800' },
  ...
  refunding_payment: { label: '退款待审核', bgColor: 'bg-orange-100', textColor: 'text-orange-800' },
