...
export function About() {
  ...
  return (
    <section id="about" className="py-20 px-4 bg-[#FEF2F2]">
      <div className="max-w-7xl mx-auto">
        {/* Section Title */}
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6 font-['Noto_Serif_TC'] text-[#450A0A]">{about.title}</h2>
          <p className="text-lg text-[#450A0A] max-w-2xl mx-auto font-['Noto_Sans_TC']">{about.description}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h3 className="text-3xl font-bold mb-6 font-['Noto_Serif_TC'] text-[#450A0A]">我们的故事</h3>
            <p className="text-lg text-[#450A0A] mb-6 font-['Noto_Sans_TC']">
              {about.content}
            </p>
            <p className="text-lg text-[#450A0A] mb-8 font-['Noto_Sans_TC']">
              我们致力于传承传统的紫砂工艺，同时将其带给世界各地的现代茶爱好者。每件作品都由我们技艺精湛的工匠精心制作，他们经过多年的磨练，掌握了这门独特的工艺。
            </p>
            <button className="bg-[#CA8A04] hover:bg-[#B47C03] text-white px-8 py-4 rounded-md font-medium transition-all duration-300 transform hover:scale-105 font-['Noto_Sans_TC'] text-lg">
              {t('hero.cta')}
            </button>
          </div>
          <div className="space-y-6">
            {/* Feature Cards */}
            <div className="bg-white p-6 rounded-lg shadow-lg border border-[#7C2D12]/20 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 font-['Noto_Serif_TC'] text-[#450A0A]">正宗工艺</h4>
                  <p className="text-[#450A0A] font-['Noto_Sans_TC']">每件茶壶都由技艺精湛的工匠使用传统技艺手工制作。</p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg border border-[#7C2D12]/20 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 font-['Noto_Serif_TC'] text-[#450A0A]">优质材料</h4>
                  <p className="text-[#450A0A] font-['Noto_Sans_TC']">我们只使用从传统矿山采集的优质宜兴紫砂泥。</p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg border border-[#7C2D12]/20 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 font-['Noto_Serif_TC'] text-[#450A0A]">客户满意</h4>
                  <p className="text-[#450A0A] font-['Noto_Sans_TC']">我们致力于为客户提供最好的产品和服务。</p>
                </div>
              </div>
            </div>
          </div>
