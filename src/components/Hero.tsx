        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <div className="space-y-2">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-dark dark:text-white leading-tight">
                {t('hero.title')}
              </h1>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 bg-accent text-white px-4 py-2 rounded-md shadow-lg font-bold">
              {t('hero.cta')}
            </div>
          </div>
        </div>
