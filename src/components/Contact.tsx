...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-20 px-4 bg-[#FDF2F8] middle-east-pattern">
      <div className="max-w-7xl mx-auto">
        {/* Section Title */}
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6 font-['Noto_Naskh_Arabic'] text-[#831843]">{contact.title}</h2>
          <p className="text-lg text-[#831843] max-w-2xl mx-auto font-['Noto_Sans_Arabic']">{contact.description}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          {/* Contact Form */}
          <div className="bg-white/80 glass-effect p-8 rounded-lg shadow-lg border border-[#DB2777]/20 transition-all duration-300 hover:shadow-xl">
            <h3 className="text-3xl font-semibold mb-6 font-['Noto_Naskh_Arabic'] text-[#831843]">发送消息</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block mb-3 font-medium font-['Noto_Sans_Arabic'] text-[#831843]">{t('contact.form.name')}</label>
                <input 
                  type="text" 
                  id="name" 
                  name="name"
                  ...
                  className="w-full px-4 py-3 border border-[#DB2777]/30 rounded-md focus:outline-none focus:ring-2 focus:ring-[#CA8A04] focus:border-transparent font-['Noto_Sans_Arabic']"
                  required
                />
              </div>
              <div>
                <label htmlFor="email" className="block mb-3 font-medium font-['Noto_Sans_Arabic'] text-[#831843]">{t('contact.form.email')}</label>
                <input 
                  type="email" 
                  id="email" 
                  name="email"
              ...
              <div>
                <label htmlFor="message" className="block mb-3 font-medium font-['Noto_Sans_Arabic'] text-[#831843]">{t('contact.form.message')}</label>
                <textarea 
                  id="message" 
                  name="message"
                  rows={5}
              ...
              <button 
                ...
                className="bg-[#CA8A04] hover:bg-[#B47C03] text-white px-8 py-4 rounded-md font-medium transition-all duration-300 transform hover:scale-105 w-full font-['Noto_Sans_Arabic'] text-lg"
              >
          ...
          <div className="space-y-8">
            <div className="bg-white/80 glass-effect p-8 rounded-lg shadow-lg border border-[#DB2777]/20 transition-all duration-300 hover:shadow-xl">
              <h3 className="text-3xl font-semibold mb-6 font-['Noto_Naskh_Arabic'] text-[#831843]">联系信息</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2 font-['Noto_Naskh_Arabic'] text-[#831843]">地址</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2 font-['Noto_Naskh_Arabic'] text-[#831843]">邮箱</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold mb-2 font-['Noto_Naskh_Arabic'] text-[#831843]">电话</h4>
            ...
            <div className="bg-white/80 glass-effect p-8 rounded-lg shadow-lg border border-[#DB2777]/20 transition-all duration-300 hover:shadow-xl">
              <h3 className="text-3xl font-semibold mb-6 font-['Noto_Naskh_Arabic'] text-[#831843]">营业时间</h3>
              <pre className="text-[#831843] font-['Noto_Sans_Arabic'] whitespace-pre-wrap">{contact.openingHours}</pre>
            </div>
          </div>
        </div>
      </div>
