    ...
    <div className="py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Left sidebar - filters - only show on desktop (lg and above) */}
          <div className="hidden lg:block lg:w-1/4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              ...
              {/* Price range */}
              <div className="mb-6">
                <h4 className="text-sm font-medium mb-2">{t('products.price_range')}</h4>
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="w-24 px-2 py-1 border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded"
                  />
                  <span>to</span>
                  <input
                    type="number"
                    max="5000"
                    value={maxPrice}
                    onChange={(e) => setMaxPrice(parseFloat(e.target.value) || 5000)}
                    className="w-24 px-2 py-1 border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded"
                  />
                  <span>AED</span>
                </div>
              ...
              {/* Materials */}
              <div className="mb-6">
                <h4 className="text-sm font-medium mb-2">{t('products.materials')}</h4>
