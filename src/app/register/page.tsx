      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium font-['Noto_Sans_Arabic'] text-[#831843]">
                {t('register.name')}
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-medium font-['Noto_Sans_Arabic'] text-[#831843]">
                {t('register.phone')}
              </label>
              <input
                id="phone"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium font-['Noto_Sans_Arabic'] text-[#831843]">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="terms" className="ml-2 block text-sm font-['Noto_Sans_Arabic'] text-[#831843]/70">
              {t('register.terms')}
            </label>
          </div>
